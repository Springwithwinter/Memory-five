...
UUID=${UUID:-'894907f6-926c-43b6-a0cc-22bf087e6f29'}
VMESS_WSPATH=${VMESS_WSPATH:-'/894907f6-926c-43b6-a0cc-22bf087e6f29-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/894907f6-926c-43b6-a0cc-22bf087e6f29-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/894907f6-926c-43b6-a0cc-22bf087e6f29-trojan'}
SS_WSPATH=${SS_WSPATH:-'/894907f6-926c-43b6-a0cc-22bf087e6f29-shadowsocks'}
